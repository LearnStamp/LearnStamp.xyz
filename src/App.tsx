        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 p-6 rounded-lg bg-background border">
              ...
              <h3 className="text-xl font-semibold">Timestamp-First Learning</h3>
            ...
            <div className="text-center space-y-4 p-6 rounded-lg bg-background border">
              ...
              <h3 className="text-xl font-semibold">Community-Refined Quality</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center space-y-4 p-6 rounded-lg bg-background border">
              ...
              <h3 className="text-xl font-semibold">Verifiable Achievements</h3>
              <p className="text-muted-foreground">
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="space-y-2">
              ...
              <div className="text-sm text-muted-foreground">Videos Enhanced</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl md:text-4xl font-bold text-primary">50K+</div>
              <div className="text-sm text-muted-foreground">Stamps Earned</div>
            </div>
            <div className="space-y-2">
        ...
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="text-lg px-12 py-6 h-auto border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary"
              onClick={() => setShowDemo(true)}
            >
              Watch Demo
            </Button>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-muted-foreground">© 2024 LearnStamp. All rights reserved.</span>
            </div>
